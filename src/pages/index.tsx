  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Tasky8 - Your Ultimate Solution for Organizing Tasks. Simplify Your Life, Enhance Productivity and Achieve More with Our Todo List App."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1484480974693-6ca0a78fb36b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx0b2RvJTIwbGlzdHxlbnwwfHx8fDE2OTg5MTQzMDZ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Tasky8 - Your Ultimate Solution for Organizing Tasks. Simplify Your Life, Enhance Productivity and Achieve More with Our Todo List App.`}
            </Text>
            <Box
