...
import { useListFindFirst, useRoqClient } from 'lib/roq';
...
function ListViewPage() {
  ...
  const queryParams = useMemo<{ include: { team: boolean; user: boolean } }>(
    () =>
  ...
  const { data, error, isLoading } = useListFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('list', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/lists/edit/${id}`} passHref legacyBehavior>
                    <Button
