...
import { useTeamFindFirst, useRoqClient } from 'lib/roq';

import { TeamInterface } from 'interfaces/team';
import { ListListPage } from 'pages/lists';
...
function TeamViewPage() {
  ...
  const { data, error, isLoading } = useTeamFindFirst(queryParams, {}, { disabled: !id });
        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              ...
              <EntityImage entity="team" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
