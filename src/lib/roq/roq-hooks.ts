...
export function useListFindMany<
  T extends Prisma.listFindManyArgs,
  R extends GetFindResult<Prisma.$listPayload<DefaultArgs>, T>[],
>(args?: Prisma.SelectSubset<T, Prisma.listFindManyArgs>, options?: RequestOptions, swrOptions?: SWRRequestOptions<R>) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useListFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.list.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useListCount<T extends Prisma.listCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.listCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useListCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.list.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useListFindManyWithCount<
  T extends Prisma.listFindManyArgs,
  R extends { data: GetFindResult<Prisma.$listPayload<DefaultArgs>, T>[]; count: number },
>(args?: Prisma.SelectSubset<T, Prisma.listFindManyArgs>, options?: RequestOptions, swrOptions?: SWRRequestOptions<R>) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useListFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.list.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useListFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useListFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.list.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
